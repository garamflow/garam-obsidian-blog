...
#### 주문 도메인 객체 다이어그램2
![주문 도메인 객체 다이어그램2](/media/Spring/[김영한]%20스프링%20핵심%20원리%20-%20기본편/2/주문%20도메인%20객체%20다이어그램2.png)
...
### (1) 할인 정책 인터페이스와 구현체
```java
// src/main/java/hello.com/discount/DiscountPolicy
...
```java
// src/main/java/hello.com/discount/FixDiscountPolicy
